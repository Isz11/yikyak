...
if(isset($_POST['upvote']) && isset($_SESSION["loggedin"])){
    ...
    if($alreadyupvoted1 > 0){
        echo $alreadyupvoted1 . ' this is already upvoted'; //this is just for testing purposes
    } elseif($alreadydownvoted1 > 0) {
        $sqlu3 = "UPDATE votes SET vote = 1 WHERE yak = $yakid";
        $sqlu4 = "UPDATE yaks SET score = score + 2 WHERE id = $yakid";
        ...
        $sqlu5 = "INSERT INTO votes(user,yak,vote) VALUES('$id','$yakid','1')";
        $sqlu6 = "UPDATE yaks SET score = score + 1 WHERE id = $yakid";
...
if(isset($_POST['downvote']) && isset($_SESSION["loggedin"])){
    ...
    if($alreadydownvoted2 > 0){
        echo $alreadyupvoted2 . ' this is already downvoted'; //this is just for testing purposes
    } elseif($alreadyupvoted2 > 0) {
        $sqld3 = "UPDATE votes SET vote = -1 WHERE yak = $yakid";
        $sqld4 = "UPDATE yaks SET score = score - 2 WHERE id = $yakid";
        ...
        $sqld5 = "INSERT INTO votes(user,yak,vote) VALUES('$id','$yakid','-1')";
        $sqld6 = "UPDATE yaks SET score = score - 1 WHERE id = $yakid";
