...
<head>
    ...
    <title>{{ config('app.name', 'Yik Yak') }}</title>
...
<body>
    <div id="app">
        <nav class="navbar navbar-expand-md navbar-light bg-white shadow-sm">
            <div class="container">
                <a class="col align-left" href="{{ url('/') }}">
                    <img src="{{ asset('img/yikyak.png') }}" width="200" height="auto" alt="yikyak logo">
                </a>
                            ...
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    ...
                                    <a class="dropdown-item" href="{{ route('communities.index') }}">
                                        {{ __('Find your University community') }}
                                    </a>
